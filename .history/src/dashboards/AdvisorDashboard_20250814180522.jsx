...
import AddUserForm from "../components/AddUserForm"; // Assuming this is needed for Advisor
    ...
    <div className="min-h-screen bg-nhs-blue-light py-8 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-7xl mx-auto">
        <header className="mb-8 text-center">
          <h1 className="text-5xl font-serif text-nhs-blue-dark mb-2">Advisor Dashboard test</h1>
        ...
        <div className="bg-white p-8 rounded-lg shadow-xl">
          ...
          <div className="space-y-6">
            <DashboardCard
              title="Add New User"
              description="Add members, officers, advisors, or creators."
            >
              <AddUserForm />
            </DashboardCard>

            <DashboardCard
              title="Pending Advisor Requests"
            >
              {pendingRequests.length > 0 ? (
                    ...
                    <li key={req.id} className="py-2 flex justify-between items-center">
                      ...
                      <div className="space-x-2">
                        <button
                          ...
                          className="px-4 py-2 bg-nhs-blue-dark text-white rounded-lg hover:bg-nhs-blue-dark/90 transition duration-300 ease-in-out transform hover:scale-105"
                        >Approve</button>
                        <button
                ...
                <p className="text-gray-700 text-center">No pending requests.</p>
              )}
            </DashboardCard>

            <DashboardCard
              title="Add Hours"
              description="Manually add service hours for members."
            >
          ...
          <div className="space-y-6">
            <DashboardCard
              ...
              description="Quick actions for managing the system."
            >
            ...
            <DashboardCard
              title="Grant/Revoke Temporary Advisor"
            >
              <ul className="divide-y divide-gray-200">
                {allUsers.filter(u => u.role === 'officer').map(officer => (
                  <li key={officer.id} className="py-2 flex justify-between items-center">
                    ...
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg text-white ${officer.temporaryAdvisor ? "bg-red-600 hover:bg-red-700" : "bg-green-600 hover:bg-green-700"} transition duration-300 ease-in-out transform hover:scale-105`}
                    >
